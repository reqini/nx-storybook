...
const getItemPropertiesTv = ({
  ...
  let imaFull = isSerie
    ? get(event, 'ext_eventimage.cast_ensemble_16_9') !== '' &&
      get(event, 'ext_eventimage.cast_ensemble_16_9')
    : get(event, 'ext_eventimage.key_art_16_9') !== '' && get(event, 'ext_eventimage.key_art_16_9')
  ...
  return {
    ...
    image_channel: resizeImage(get(item, 'image') || get(item, 'channel_image'), 290),
...
const getItemProperties = ({ item, version = 'v5.86', category }) => {
  ...
  const imaCardSerie = isSerie ? get(external, 'gracenote.assets.banner_l1_16_9') : null
  /* let imaCard =
    imaCardSerie ||
  ...
  const imaFullSerie = isSerie ? get(external, 'gracenote.assets.cast_ensemble_16_9') : null
  ...
  */
  ...
  imaFull = itemFinal.vcardSerie ? get(external, 'gracenote.assets.iconic_16_9') : imaFull // ver bien de donde sale full para series en vcard
...
export { getItemPropertiesTv, getItemPropertiesTalent, getItemProperties, resizeImage }
