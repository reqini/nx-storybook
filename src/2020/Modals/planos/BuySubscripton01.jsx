      ...
      <div className={classes.container03}>
        ...
        <div className={classes.logoDescription}>
          {item.type !== "plan" ? (
            <img
              src={
                item.items[0].composition.systemParameters.IMAGE_URL.includes("?h=72") ? item.items[0].composition.systemParameters.IMAGE_URL : item.items[0].composition.systemParameters.IMAGE_URL + "?h=72"
              }
                    ...
                    <li key={id}>
                      ...
                      >
                        <div className={classes.itemImage}>
                          <img
                            src={
                              data.composition.systemParameters.IMAGE_URL.includes("?h=72") ? data.composition.systemParameters.IMAGE_URL : data.composition.systemParameters.IMAGE_URL +
                              "?h=72"
                            }
                            alt={data.composition.systemParameters.DISPLAY_NAME}
                          />
