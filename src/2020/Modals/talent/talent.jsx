...
const ModalElenco = ({
  ...
  const name = get(talent, 'name') || get(talent, 'first_name') || get(talent, 'title')
  const lastName = get(talent, 'surname') || get(talent, 'last_name')
  const imageTalent = get(talent, 'imageCard') || get(talent, 'image') || get(talent, 'cover')
  ...
  useEffect(() => {
    ...
    getTalentData((talent.internal_ids && talent.internal_ids[0]) || talent.group_id)
  }, [])
