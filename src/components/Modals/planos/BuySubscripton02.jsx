  ...
  return (
    <div>
      ...
      <div className={classes.container03}>
        ...
        <h3>
          {Translator.get(
            "net_assinatura_confirmacion_assinatura",
            "Assinatura"
          )}
        </h3>
        <h2>{Translator.get("net_assinatura_confirmacion_precio", "Preço")}</h2>
        <h3>
        ...
        <h2>
          {Translator.get("net_assinatura_confirmacion_tarjeta", "Cartao")}
        </h2>
        <div
          style={{
            fontSize: "32px",
            ...
            <h3 className="data-value">
              <div className="price-plans">
                ...
                {item.validity.period === "MONTH"
                  ? Translator.get("net_planos_mes", "/mes")
                  : Translator.get("net_planos_day", "/día")}
              </div>
            </h3>
          ),
        })}
