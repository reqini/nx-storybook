...
const Keyboard = ({
  ...
  const getKeysLayout = () => {
    ...
    if (typeKeyboard === "upper") {
      return typeof TvLatinUpper.layout[DeviceStorage.getItem("region")] !==
        "undefined"
        ? TvLatinUpper.layout[DeviceStorage.getItem("region")]
        : TvLatinUpper.layout["default"];
    }

    return typeof TvLatinLower.layout[DeviceStorage.getItem("region")] !==
      "undefined"
  ...
  const getKeysLayoutNumber = () => {
    return typeof TvLatinLower.layoutNumber[DeviceStorage.getItem("region")] !==
      "undefined"
  ...
  const getKeysLayoutHeader = () => {
    return typeof TvLatinLower.layoutHeader[DeviceStorage.getItem("region")] !==
      "undefined"
  ...
  const thereIsAnotherKeyboard = () => {
    let existModalKeyboard =
      document.getElementsByClassName("keyboard modal").length > 0;
        ...
        >
          <div className={classes.formContainer}>
            ...
            <div>
              ...
              />
              <KeyboardButton
                value={Translator.get("net_teclado_espacio", "ESPAÇO")}
