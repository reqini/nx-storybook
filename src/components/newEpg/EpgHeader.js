...
const EpgHeader = ({
  ...
  return (
    <div
      className={`${classes.epgHeader} ${
        type === "MINI" ? classes.transparent : null
      }`}
      style={{
